...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-gray-50 shadow">
                ...
                <div className="lg:w-1/3">
                    <Link  className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full dark:dark:bg-violet-400">
                             <img src={workerLogo} alt="" />
                        </div>
                        <span className="self-center text-2xl font-semibold">Day Labour</span>
                    </Link>
                </div>
            ...
            <div className="py-6 text-sm text-center dark:dark:text-gray-400">© 2022 Rs Ruh. All rights reserved.</div>
        </footer>
    );
};
